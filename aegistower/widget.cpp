...
Widget::Widget()
    ...
    m_hover_color_r(0.0f), m_hover_color_g(0.0f), m_hover_color_b(0.0f),
    m_click_color_r(0.0f), m_click_color_g(0.0f), m_click_color_b(0.0f),
    m_is_hovered(false), m_is_clicked(false), m_font_path(Globalstate::getInstance()->getFontsDir()),
    m_font_size(0.0f),
    m_font_pos_x(0.0f),
    m_font_pos_y(0.0f),
    m_text_r(0.0f),
...
void Widget::setHoverColor(float r, float g, float b)
{
    m_hover_color_r = r;
    m_hover_color_g = g;
    m_hover_color_b = b;
...
void Widget::setClickColor(float r, float g, float b)
{
    m_click_color_r = r;
    m_click_color_g = g;
    m_click_color_b = b;
...
bool Widget::check_if_hovered()
{
    ...
    bool m_state = check_mouse_pos(m_x, m_y);

    if (m_state)
    {
        return m_is_hovered = true;
    }
    else
    {
        return m_is_hovered = false;
    }
}
...
void Widget::restore_brush_properties()
{
    ...
    m_widget_brush.outline_opacity = 1.f;
...
void Widget::calculate_text_position()
{
    ...
    case RIGHT:
        ...
        //case RIGHT:
          //  m_font_pos_x = m_widget_x + m_widget_width - (m_font_size * m_font_text.length()) / 2.0f - 5.0f;
            //break;
    default:
        break;
    }
